  ...
  <div>
          ...
          <div class="pt-6 px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
              <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                <div class="flex items-center justify-between w-full md:w-auto">
                  ...
                  <div class="-mr-2 flex items-center md:hidden">
                    <button @click="isNavOpen = true" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
              ...
              <div class="hidden md:block md:ml-10 md:pr-4">
                ...
                <a href="#" class="ml-8 font-medium text-purple-600 hover:text-purple-900 focus:outline-none focus:text-purple-700 transition duration-150 ease-in-out">Log in</a>
              </div>
            </nav>
          </div>

          <div v-if="isNavOpen" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
            <div class="rounded-lg shadow-md">
              <div class="rounded-lg bg-white shadow-xs overflow-hidden">
                <div class="px-5 pt-4 flex items-center justify-between">
                  ...
                  <div class="-mr-2">
                    <button @click="isNavOpen = false" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                      <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                ...
                <div>
                  <a href="#" class="block w-full px-5 py-3 text-center font-medium text-purple-600 bg-gray-50 hover:bg-gray-100 hover:text-purple-700 focus:outline-none focus:bg-gray-100 focus:text-purple-700 transition duration-150 ease-in-out">
                    Log in
                  </a>
                </div>
              </div>
          ...
          <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              <h2 class="text-3xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-4xl sm:leading-none md:text-5xl">
                We know you're lazy.
                <br />
                <span class="text-purple-600">Let us worry about your subscriptions.</span>
              </h2>
              <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                We keep track of your precious subscriptions and notify you when it's time to empty your wallet.
              </p>
              <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div class="rounded-md shadow">
                  <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-purple-600 hover:bg-purple-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                    Get started
                  </a>
                </div>
    ...
    <div class="py-12 bg-white">
      <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <p class="text-base leading-6 text-purple-600 font-semibold tracking-wide uppercase">Transactions</p>
          ...
          <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
            <li>
              <div class="flex">
                ...
                <div class="ml-4">
                  <h5 class="text-lg leading-6 font-medium text-gray-900">No credit card required</h5>
      ...
      <div class="pt-12 sm:pt-16 lg:pt-24">
        <div class="max-w-screen-xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div class="max-w-3xl mx-auto lg:max-w-none">
            ...
            <p class="mt-2 text-xl leading-7 text-purple-300">
              ...
              <div class="rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="px-6 pt-6 pb-8 bg-gray-50 sm:p-10 sm:pt-6">
                  ...
                  <div class="mt-6 rounded-md shadow">
                    <a href="#" class="flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-purple-500 hover:bg-purple-400 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                      Get started
                    </a>
                  </div>
                </div>
      ...
      <div class="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="relative lg:flex lg:items-center">
          <div class="hidden lg:block lg:flex-shrink-0">
            <img class="h-64 w-64 rounded-full xl:h-80 xl:w-80" src="https://scontent-arn2-2.xx.fbcdn.net/v/t31.0-8/30073228_1809210845809837_2153403105528153561_o.jpg?_nc_cat=100&_nc_sid=7aed08&_nc_ohc=BlOC1rsitnAAX9WUfWW&_nc_ht=scontent-arn2-2.xx&oh=6a22c35947771509df201352b446234b&oe=5E9724E3" alt="" />
          </div>

          <div class="relative lg:ml-10">
            <svg class="absolute top-0 left-0 transform -translate-x-8 -translate-y-24 h-36 w-36 text-purple-200 opacity-50" stroke="currentColor" fill="none" viewBox="0 0 144 144">
              ...
              <footer class="mt-8">
                <div class="flex">
                  <div class="flex-shrink-0 lg:hidden">
                    <img class="h-12 w-12 rounded-full" src="https://scontent-arn2-2.xx.fbcdn.net/v/t31.0-8/30073228_1809210845809837_2153403105528153561_o.jpg?_nc_cat=100&_nc_sid=7aed08&_nc_ohc=BlOC1rsitnAAX9WUfWW&_nc_ht=scontent-arn2-2.xx&oh=6a22c35947771509df201352b446234b&oe=5E9724E3" alt="" />
                  </div>
                  <div class="ml-4 lg:ml-0">
                    <div class="text-base leading-6 font-medium text-grya-900">Bobster Lobster</div>
                    <div class="text-base leading-6 font-medium text-purple-600">CEO, Bobisoft</div>
                  </div>
                </div>
              </footer>
            </blockquote>
    ...
    <div class="bg-white">
      <div class="max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
        <div class="px-6 py-6 bg-purple-700 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
          ...
          <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
            ...
            <p class="mt-3 text-sm leading-5 text-purple-200">
